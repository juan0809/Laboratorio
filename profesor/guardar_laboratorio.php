...
if ($titulo == '' || $descripcion == '' || $objetivos == '' || $file == '' || $materiaId == '') {
...
if ($validar) {
    ...
    $sql = "INSERT INTO laboratorios (titulo, imagen, descripcion, objetivos, materia_id) VALUES ('$titulo', '$file', '$descripcion', '$objetivos', '$materiaId')";
    ...
    if (isset($_POST['input_array_titulo'])) {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            // Print all POST data to the console
