...
<main class="app-content">
  <div class="app-title">
    <div>
      <h1><i class="fa fa-dashboard"></i>Laboratorios</h1>
      <button class="btn btn-success" type="button" onclick="openModalContenido()">Nuevo
        Laboratorio</button>
    </div>
        ...
        <div class="col-md-12">
          <div class="tile">
            <div class="title-title-w-btn">
              ...
              <p><button class="btn btn-info icon-btn" onclick="editarContenido(<?=
                $data['contenido_id']; ?>)">
                  <i class="fa fa-edit"></i>Editar Contenido</button>
                <button class="btn btn-danger icon-btn" onclick="eliminarContenido(<?=
                  $data['contenido_id']; ?>)">
              ...
              <div class="title-footer-mt4">
                <div class="input-group">
                  ...
                  <a class="btn btn-primary" href="BASE_URL<?= $data['material']; ?>" target="_blank">Material de
                    Descarga</a>
                </div>
              </div>
            </div>
